...
import { MistralClient } from "../../infrastructure/ai/providers/mistral/MistralClient";
...
async function main() {
    ...
    if (!MISTRAL.apiKey) {
        ...
        console.error(
            ...
            "No se ha configurado MISTRAL_API_KEY en tu .env."
    ...
    console.log(MISTRAL.embeddingModel);
