...
import { SourceDocumentDiscovery } from "../../src/domain/game/services/SourceDocumentDiscovery";
...
describe("SourceDocumentDiscovery", () => {
    ...
    it("devuelve una lista vacía si la carpeta source/ no existe", async () => {
        ...
        const discovery =
            ...
            new SourceDocumentDiscovery(fileSystem);
